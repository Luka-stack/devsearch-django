...
urlpatterns = [
    ...
    path('inbox/', view=views.inbox, name="inbox"),
    path('message/<str:pk>/', view=views.view_message, name="message"),
    path('send-message/<str:pk>/',
         view=views.send_message, name="send-message")
]
